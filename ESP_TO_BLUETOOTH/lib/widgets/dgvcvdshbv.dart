...
//     } catch (e) {
//       Snackbar.show(ABC.c, prettyException("Read Error:", e.toString()), success: false);
//     }
//   }
...
//   Widget buildValue(BuildContext context, bool onPressed) {
//     // const asciiDecoder = AsciiDecoder(allowInvalid:true);

//     // li data = _value.toString();  
//     if(onPressed){
...
//     print(onPressed);
//     print("*********************************************************");
//     // return Text(decoded, style: TextStyle(fontSize: 13, color: Colors.grey));
//     }
//     var decoded = ascii.decode(_value);
//     flutterTts.speak(decoded);
//     return Text(decoded, style: TextStyle(fontSize: 13, color: Colors.grey));
...
//     return TextButton(
//         child: _isPressed ? Text ("Reading") : Text ("Read"),
//         onPressed: () async {
//           await onReadPressed();
//           setState(() {
